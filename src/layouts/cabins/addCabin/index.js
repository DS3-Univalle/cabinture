...
function AddCabinComponent() {
  ...
  const handleClick = async (e) => {
    e.preventDefault();
    try {
      await axios.post("http://localhost:8081/create-cabin", cabin, {
        headers: {
      ...
      console.log("done");
      // Muestra el mensaje de éxito con Sweet Alert
      Swal.fire({
        icon: 'success',
      ...
      setAgregarBTN(false);
      setEliminarBTN(true);
      setActualizarBTN(true);
    } catch (err) {
      console.log(err);
      // Muestra un mensaje de error con Sweet Alert
      Swal.fire({
        icon: 'error',
                ...
                <SoftBox pt={3} pb={2} px={2}>
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={4}>
                      ...
                      <SoftButton className="softButtonCustomColor" style={{ backgroundColor: "#71C455", color: "white", width: "100%" }} onClick={handleClick} >
                        &nbsp;Agregar
                      </SoftButton>
                    </Grid>)}
                    {ActualizarBTN && (
                    ...
                    {eliminarBTN && (
                    <Grid item xs={4}>
                        <SoftButton className="softButtonCustomColor" style={{ backgroundColor: "#C45555", color: "white", width: "100%" }} >
                          &nbsp;Eliminar
                        </SoftButton>
                    </Grid> )}
                  </Grid>
